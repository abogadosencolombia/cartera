...
const form = useForm({
  ...
  // 👇 nuevo campo (si no viene, inicia vacío)
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
          <div class="p-6 md:p-8">
            <form @submit.prevent="submit" class="space-y-8">
              <!-- Datos básicos -->
              <section>
                <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">Datos de {{ persona.nombre_completo }}</h3>
              ...
              <section>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mb-3">
                  Edita o agrega enlaces (Facebook, Instagram, LinkedIn, sitio web, etc.).
                </p>
