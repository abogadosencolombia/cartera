...
import SelectInput from '@/Components/SelectInput.vue'; // <-- 1. IMPORTAMOS EL SELECTOR
import { Head, Link, usePage } from '@inertiajs/vue3';
import { ref, watch, computed } from 'vue';
import { 
    UserIcon, BriefcaseIcon, ShieldCheckIcon, BuildingOffice2Icon, // Roles
    PencilSquareIcon, LockClosedIcon, LockOpenIcon // Acciones
...
const roleFilter = ref(''); // <-- 2. NUEVO REF PARA FILTRO DE ROL
const statusFilter = ref(''); // <-- 3. NUEVO REF PARA FILTRO DE ESTADO
