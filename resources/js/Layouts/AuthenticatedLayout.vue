...
import {
    ...
    BanknotesIcon, // ← NUEVO: icono para “Tasas de Interés”
...
const NAV_ITEMS = [
    ...
    // === Configuración (Solo Admin) ===
    {
        ...
        active: [
            ...
            'admin.tasas.*', // ← NUEVO: patrón activo para “Tasas de Interés”
        ],
        roles: ['admin'],
        items: [
    ...
    // === Herramientas Externas ===
    {
        ...
        items: [
            ...
            { type: 'external', label: 'Asistente ChatGPT', href: 'https://chat.openai.com/', roles: ['admin', 'gestor', 'abogado'] },
